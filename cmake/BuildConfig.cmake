...
SET(DEFAULT_INCLUDE_PATH include)
...
SET(CMAKE_INCLUDE_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/${DEFAULT_INCLUDE_PATH})
...
# Check if SSE 4.1 is supported

INCLUDE (CheckSymbolExists)
CHECK_SYMBOL_EXISTS(__SSE__ "xmmintrin.h" SUPPORTS_SSE1)
SET(SUPPORTS_SSE1 CACHE BOOL "supports SSE" ${SUPPORTS_SSE1})
SET(SUPPORTS_SSE1 TRUE)

CHECK_SYMBOL_EXISTS(__SSE2__ "emmintrin.h" SUPPORTS_SSE2)
SET(SUPPORTS_SSE2 CACHE BOOL "supports SSE2" ${SUPPORTS_SSE2})
SET(SUPPORTS_SSE2 TRUE)

CHECK_SYMBOL_EXISTS(__SSE4_1__ "smmintrin.h" SUPPORTS_SSE41)
SET(SUPPORTS_SSE41 CACHE BOOL "supports SSE4.1" ${SUPPORTS_SSE41})
#SET(SUPPORTS_SSE41 TRUE)
...
IF(INSTALL_COPYABLE)
  ...
  SET(PIXHAWK_INCLUDE_INSTALL_PATH ${DEFAULT_INCLUDE_PATH})
...
ELSEIF(UNIX) # Apple too?
  ...
  SET(PIXHAWK_LIBRARY_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/lib)
  SET(PIXHAWK_INCLUDE_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/include/mavconn)
  SET(PIXHAWK_ARCHIVE_INSTALL_PATH ${CMAKE_INSTALL_PREFIX}/lib/static)
  SET(PIXHAWK_DOC_INSTALL_PATH     ${CMAKE_INSTALL_PREFIX}/share/doc/mavconn)
  SET(PIXHAWK_MEDIA_INSTALL_PATH   ${CMAKE_INSTALL_PREFIX}/share/mavconn)
