...
FUNCTION(PIXHAWK_INSTALL)
  ...
  SET(MAVCONN_CORE_CORELIB_HEADERS
	${CMAKE_SOURCE_DIR}/src/core/corelib/Core.h
  )
  INSTALL(FILES ${MAVCONN_CORE_CORELIB_HEADERS} DESTINATION ${PIXHAWK_INCLUDE_INSTALL_PATH}/core/corelib/)

  SET(MAVCONN_CORE_TIMER_HEADERS
	${CMAKE_SOURCE_DIR}/src/core/corelib/timer/OgreTimer.h
	${CMAKE_SOURCE_DIR}/src/core/corelib/timer/OgreTimerImp.GLX.h
	${CMAKE_SOURCE_DIR}/src/core/corelib/timer/Timer.h
  )
  INSTALL(FILES ${MAVCONN_CORE_TIMER_HEADERS} DESTINATION ${PIXHAWK_INCLUDE_INSTALL_PATH}/core/corelib/timer/)
