...
unsigned long Timer::getSeconds()
{
    ...
    unsigned long newSeconds = (unsigned long) (newTime / mFrequency.QuadPart);
...
//-------------------------------------------------------------------------
unsigned long Timer::getSecondsCPU()
{
	clock_t newClock = clock();
	return (unsigned long)( (float)( newClock - mZeroClock ) / ( CLOCKS_PER_SEC  ) ) ;
}
