...
namespace Ogre
{
	...
	public:
        ...
        */
        bool setOption( const std::string& strKey, const void* pValue ) { return false; }
		...
		/** Returns seconds since initialisation or last reset, only CPU time measured */
		unsigned long getSecondsCPU();
